...
<details>
<summary><b>[18] Yrsa-MediumItalic.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Yrsa Medium Italic: OS/2 sTypoAscender is 930 when it should be 728 [code: bad-typo-ascender]
* 🔥 **FAIL** Yrsa Medium Italic: OS/2 sTypoDescender is -430 when it should be -272 [code: bad-typo-descender]
* 🔥 **FAIL** Yrsa Medium Italic: hhea Ascender is 930 when it should be 728 [code: bad-hhea-ascender]
* 🔥 **FAIL** Yrsa Medium Italic: hhea Descender is -430 when it should be -272 [code: bad-hhea-descender]
...
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 939, but got 930 instead [code: ascent]
