...
<details>
<summary><b>[14] Yrsa-Medium.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Yrsa Medium: OS/2 sTypoAscender is 971 when it should be 728 [code: bad-typo-ascender]
* 🔥 **FAIL** Yrsa Medium: OS/2 sTypoDescender is -423 when it should be -272 [code: bad-typo-descender]
* 🔥 **FAIL** Yrsa Medium: hhea Ascender is 971 when it should be 728 [code: bad-hhea-ascender]
* 🔥 **FAIL** Yrsa Medium: hhea Descender is -423 when it should be -272 [code: bad-hhea-descender]
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam: L<<96.0,174.0>--<71.0,540.0>> -> L<<71.0,540.0>--<71.0,606.0>> and 22 more. [code: found-colinear-vectors]
