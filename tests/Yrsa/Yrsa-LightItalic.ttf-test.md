...
<details>
<summary><b>[18] Yrsa-LightItalic.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Yrsa Light Italic: OS/2 sTypoAscender is 930 when it should be 728 [code: bad-typo-ascender]
* 🔥 **FAIL** Yrsa Light Italic: OS/2 sTypoDescender is -430 when it should be -272 [code: bad-typo-descender]
* 🔥 **FAIL** Yrsa Light Italic: hhea Ascender is 930 when it should be 728 [code: bad-hhea-ascender]
* 🔥 **FAIL** Yrsa Light Italic: hhea Descender is -430 when it should be -272 [code: bad-hhea-descender]
...
* 🔥 **FAIL** OS/2.usWinDescent value 430 is too large. It should be less than double the yMin. Current absolute yMin value is 206 [code: descent]
