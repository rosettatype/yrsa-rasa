...
<details>
<summary><b>[20] RasaVF-Uprights-backup-fonttools-prep-gasp.ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'RasaVF-Uprights-backup-fonttools-prep-gasp.ttf' must be renamed to 'Rasa[wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
