...
You can download the compiled fonts from [Fonts](https://github.com/rosettatype/yrsa-rasa/tree/master/fonts) folder of this repo or from the Google Fonts directory.
